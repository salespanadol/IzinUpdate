    ...
    <div class="container">
        ...
        <form action="/submit-form" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="time" class="form-control" id="jam_keluar" name="jam_keluar" min="08:00" max="16:30" required>
            </div>

            <div class="mb-3">
                <label for="jam_masuk" class="form-label">Jam Masuk:</label>
                <input type="time" class="form-control" id="jam_masuk" name="jam_masuk" min="08:00" max="16:30" required>
            </div>
